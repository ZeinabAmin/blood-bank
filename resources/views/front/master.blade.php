                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="social">
                            <div class="icons">
                                ...
                                <a href="{{$settings->phone}}" target="_blank" class="whatsapp"><i class="fab fa-whatsapp"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link"  href="{{url('article-details')}}">المقالات</a>
                            </li>
                            <li class="nav-item">
                                {{-- <a class="nav-link" href="{{route('donationsclient')}}">طلبات التبرع</a> --}}
                            </li>
                            <li class="nav-item">
